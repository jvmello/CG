...
Biela::Biela(float x, float y, float z, float tam)
{
    ...
    this->pontos.push_back(new Ponto(x - m, y + 6*m, z - m));
    this->pontos.push_back(new Ponto(x + m, y + 6*m, z - m));
    this->pontos.push_back(new Ponto(x + m, y - m, z - m));
    this->pontos.push_back(new Ponto(x - m, y - m, z + m));
    this->pontos.push_back(new Ponto(x - m, y + 6*m, z + m));
    ...
    this->p_pistao = new Ponto(x, y + 5.5*m, z);
}
...
void Biela::encaixe(Ponto* p, float ang)
{
    ...
    float m = this->tam/4;
    this->pontos.push_back(new Ponto(p->x - m, p->y - m, p->z));
    this->pontos.push_back(new Ponto(p->x - m, p->y + 6*m, p->z));
    this->pontos.push_back(new Ponto(p->x + m, p->y + 6*m, p->z));
    this->pontos.push_back(new Ponto(p->x + m, p->y - m, p->z));

    this->p_pistao = new Ponto(p->x, p->y + 5.5*m, p->z);
...
void Biela::desenha3D(float d)
{
    ...
    this->p_pistao->x = this->p_pistao->x*d/this->p_pistao->z;
    this->p_pistao->y = this->p_pistao->y*d/this->p_pistao->z;
    ...
    this->p_pistao->x += this->centro->x;
    this->p_pistao->y += this->centro->y;
